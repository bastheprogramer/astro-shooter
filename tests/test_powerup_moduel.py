...
def test_apply_returns_dict():
    # Create a dummy image (10x10 solid white)
    dummy_img = pyglet.image.SolidColorImagePattern(color=(255, 255, 255, 255)).create_image(10, 10)
    ...
    powerup_instance = PowerUp(0, 0, None, dummy_img, ptype="life")
